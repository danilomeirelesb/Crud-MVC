...
<%
    ...
    ProfessorCurso professorCurso = pcDAO.pesquisar(Integer.parseInt(request.getParameter("id")));
        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                <form action="../ProfessorCursoServlet" method="post">
                    <input type="hidden" name="txId" value="<%=professorCurso.getId()%>"/>
                    <div class="row">
                        <div class="col-md">
                            ...
                            <select name="cbProfessor" id="cbProfessor" class="form-control">
                                ...
                                <option value="<%=professores.get(i).getId()%>"
                                        <% if (professores.get(i).getId() == professorCurso.getProfessorId()){%>
                                        selected <%}%>>
                                        <%=professores.get(i).getNome()%></option>
                                <% } %>
                            </select>
                        </div>
                        <div class="col-md">
