...
<%
    ...
    professor = professorDAO.pesquisar(Integer.parseInt(request.getParameter("id")));
%>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <h5 class="card-header" style="background-color: #ccccff"><strong>Editar Professor</strong></h5>
                <div class="card-body">

                    <form action="../ProfessorServlet" method="post">
                        <input type="hidden" name="txId" value="<%=professor.getId()%>"
                               <div class="row">
                            <div class="col-md-4">
                                <label for="txNome">Nome: </label>
                                <input type="text" name="txNome" id="txNome" value="<%=professor.getNome()%>" class="form-control"/>
                            </div>

                            <div class="col-md-4">
                                <label for="txFormacao">Formação: </label>
                                <input type="text" name="txFormacao" id="txFormacao" value="<%=professor.getFormacao()%>" class="form-control"/>
                            </div>
                        </div>
                        <br/>
