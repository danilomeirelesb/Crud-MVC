...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <h3 style="text-align: center">Cadastro de Curso</h3>
            ...
            <form action="../CursoServlet" method="post">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <label for="txChoraria">Carga Horária </label>
                        <input type="text" maxlength="11" name="txChoraria" id="txChoraria" class="form-control"/>
                    </div>
