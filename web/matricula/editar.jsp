...
<%
    ...
    AlunoCurso alunoCurso = acDAO.pesquisar(Integer.parseInt(request.getParameter("id")));
        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                <form action="../AlunoCursoServlet" method="post">
                    <input type="hidden" name="txId" value="<%=alunoCurso.getId()%>"/>
                    <div class="row">
                        <div class="col-md">
                            ...
                            <select name="cbAluno" id="cbAluno" class="form-control">
                                ...
                                <option value="<%=alunos.get(i).getId()%>"
                                        <% if (alunos.get(i).getId() == alunoCurso.getAlunoId()){%>
                                        selected <%}%>>
                                        <%=alunos.get(i).getNome()%></option>
                                <% } %>
                            </select>
                        </div>
                        <div class="col-md">
